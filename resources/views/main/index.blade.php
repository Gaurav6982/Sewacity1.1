            ...
            <body class="bg" onload="myFunction()">
                ...
                <div class="bouter">
                    ...
                    <div id="second-nav">
                        <div>
                            <ul>
                                ...
                                <li> <a  href="/" class="hoveractive">HOME</a> </li>
                    ...
                    @guest<div class="banner">
                            <div class="imag"> 
                                <img src="/storage/images/banner.webp" class="sticky"> 
                                <i class="fa fa-times cross" style="font-size: 30px"></i> 
                            </div>
                    </div> @endguest
                    <div class="banner">
                ...
                <!-- /header -->
                    ...
                    <main style="overflow:hidden">
                        ...
                        <div class="coronabtn"><a href="https://www.covid19india.org/state/BR" class="corona pull-right">
                                ...
                                <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <h2 class="accordion-header text-center" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button fontfamily" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                        Aapka Shehar Aapki Madad
                                        </button>
                                    </h2>
                                    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                        <div class="accordion-body text-center">
                                        <strong class="text-dark">प्रिय शहरवासियों
                        ...
                        <section id="banner-area" class="fontfamily">
                            ...
                            @foreach ($feeds as $feed)
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                        <p class="card-text text-dark"><em class="text-dark">{!!$feed->comments!!}</em></p>
                                        </div>
                        ...
                        <div class="container" style="padding:20px;">
                            ...
                            <div class="card-group">
                                <div class="card part-img">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title badge badge-danger text-wrap text-dark" style="width: 14rem; font-size: large;">
                                            www.salaamnamaste.in</h5>
                                        <p class="card-text text-dark">Salaam Namaste tries to engage the Community in all shows broadcast.
                                ...
                                <div class="card part-img">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-dark">KaroStartup is community of startups and Entrepreneurs to create a
