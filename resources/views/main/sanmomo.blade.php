    ...
    <div class="row row-cols-1 row-cols-md-3">
      ...
      <div class="col mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Dry masala fry Momo</h5>
            <p class="card-text"><b>₹ 70 --8 pcs</b></p>
          </div>
        </div>
      </div>
      <div class="col mb-4">
      ...
      <div class="col mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">veg chilli momo</h5>
            <p class="card-text"><b>₹ 100 </b></p>
          </div>
        </div>
      </div>
      ...
      <div class="col mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Veg Paneer roll </h5>
            <p class="card-text"><b>₹ 60---1 pcs</b></p>
          </div>
        </div>
      </div>
      <div class="col mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Veg steam Momo</h5>
            <p class="card-text"><b>₹ 50---8 pcs</b></p>
          </div>
        </div>
      </div>
      <div class="col mb-4">
