	...
	<div class="container" style="
		...
		<div class="card">
			...
			z-index: 2">
				...
				<p>Registered Contact Number: <?php echo $data['phone']?></p>
				<p>Registered Email: <?php echo $data['email']?></p>
				<p>I want to get a Ride:</p>
				<div style="margin:0;padding:0;text-align:center;">
				    <table style="width:100%">
				        <tr>
				            <th style="border:1px solid white">Name</th>
				            <th  style="border:1px solid white">Booking Id</th>
				            <th style="border:1px solid white">Date & Time</th>
			            ...
			            <tr>
			                <td  style="border:1px solid white"> <?php echo $data['name']?></td>
			                <td style="border:1px solid white"> <?php echo $data['bookid']?></td>
			                <td style="border:1px solid white"> <?php echo $data['time']?></td>
			                <td style="border:1px solid white"> <?php echo $data['from']?></td>
			                <td style="border:1px solid white"> <?php echo $data['to']?></td>
			                <td style="border:1px solid white"> <?php echo $data['phone']?></td>
		                </tr>
            	    </table>
            	</div>
            	<div class="container">
