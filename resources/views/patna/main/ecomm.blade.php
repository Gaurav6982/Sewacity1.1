            ...
            <div class="card-header">
                ...
                <h5>Available Products</h5> </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <form action="/patna/products" method="get">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control" name="category" id="catselect">
                                        ...
                                        <option value="12">Festival Items</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 offset-md-2">
                                    ...
                                    <a href="/patna/products?category=0&searchbox=&sort=latest&page=1" class="btn btn-danger pull-right">Reset</a>
